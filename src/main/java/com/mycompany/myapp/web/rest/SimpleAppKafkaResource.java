...
@RestController
@RequestMapping("/api/simple-app-kafka")
public class SimpleAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SimpleAppKafkaResource.class);
    ...
    public SimpleAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
